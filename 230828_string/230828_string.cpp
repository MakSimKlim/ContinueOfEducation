...
int main()
{
	...
	size_t index;
	cout << stoi(friends, &index, 10) << endl;// преобразует число встроку int 
	cout << stol(friends) << endl;// преобразует число встроку long 
	cout << stoll(friends) << endl;// преобразует число встроку long long
